...
export type MyBookedTelemedicineListPageMobileProps = {
  page: string;
  perPage: string;
  userId: string;
};

export function MyBookedTelemedicineListPageMobile(
  props: MyBookedTelemedicineListPageMobileProps
) {
  ...
  return (
    <>
      ...
      >
        <MyBookedTelemedicineList {...props} isMobile />
      </Box>
