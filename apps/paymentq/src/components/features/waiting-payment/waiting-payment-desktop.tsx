...
type WaitingPaymentDesktopType = {
...
export function WaitingPaymentDesktop(props: WaitingPaymentDesktopType) {
  const { paymentType, stateModal, onConfirmPayment, modalConfirmCC } = props;
