...
<Meta
  title="UI Docs / Text and Layer Styles"
...
> This page of documentation was inspired by [chakra-ui's text and layer styles](https://chakra-ui.com/docs/features/text-and-layer-styles)
...
it will resolve the styles accordingly.
...
```jsx
// The theme with new layer styles
...
// Consume the text styles in your components
function Example() {
  return <Box layerStyle="selected">This is a box</Box>;
}

// You can also switch layer styles
...
// Consume the text styles in your component
function Example() {
