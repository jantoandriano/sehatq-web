...
import { SimpleGrid, Box, Text } from "..";

<Meta
  title="UI Docs / Style Props"
  description="Learn how to use style props. Style props are a way to alter the
  style of a component by simply passing props to it."
/>

# Style Props

> This page of documentation was inspired by [chakra-ui's style props](https://chakra-ui.com/docs/features/style-props)
...
```jsx
import { Box } from "@sehatq/components"
...
<Box w="100%" h="200px" bgGradient="radial(gray.500, yellow.400, pink.200)" />
...
```jsx
import { Text } from "@sehatq/components"
...
```jsx
import { Box, Flex } from "@sehatq/components"
...
```jsx
import { Box, Grid } from "@sehatq/components"
...
```jsx
<Box border="1px" borderColor="gray.500">
  Card
</Box>
```
...
```jsx
import { Button } from "@sehatq/components"
...
<Canvas isExpanded>
  ...
  >
    ...
    <Box boxShadow="blue-base" p="6" rounded="md" bg="white">
      Blue base
    </Box>
    <Box boxShadow="blue-md" p="6" rounded="md" bg="white">
      Blue md
    </Box>
...
```jsx
<Button as="a" target="_blank" variant="outline" href="https://sehatq.com">
  Hello
</Button>
```
