...
<Meta title="UI Docs / Stacking Contexts" />

# Stacking Contexts

> This page of documentation was inspired by [chakra-ui's stacking context](https://chakra-ui.com/guides/z-index)
...
Portal implementation allows for nesting, and defaults to inserting
