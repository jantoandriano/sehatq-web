...
import { Box, Text, UIProvider } from "../user-interfaces";

<Meta
  title="UI Docs / Gradient"
  description="Learn how to use gradients. Gradients are a way to transition between two or more colors."
/>

# Gradient

> This page of documentation was inspired by [chakra-ui's gradient](https://chakra-ui.com/docs/features/gradient)
...
<Canvas isExpanded>
  <Box
    w="100%"
    h="200px"
    bgGradient="linear(to-r, gray.400, yellow.400, pink.200)"
  />
</Canvas>
