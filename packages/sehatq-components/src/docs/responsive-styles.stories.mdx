...
import { Box, Image, Link, Text } from "../user-interfaces";

<Meta
  title="UI Docs / Responsive Styles"
  description="It supports responsive styles out of the box."
/>

# Responsive Styles

> This page of documentation was inspired by [chakra-ui's responsive styles](https://chakra-ui.com/docs/features/responsive-styles)

It supports responsive styles out of the box. Instead of manually adding
`@media` queries and adding nested styles throughout your code, It allows
...
Responsive syntax relies on the breakpoints defined in the theme object. It provides default breakpoints, here's what it looks like:
...
To interpret array responsive values, It converts the values defined in
...
> **Remember, It uses the min-width media query for responsive design**.
