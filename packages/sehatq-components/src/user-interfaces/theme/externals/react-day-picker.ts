...
export const reactDayPicker: SystemStyleFunction = (props) => ({
  ".DayPicker *": {
    outline: "none",
  },
  ...
  ":root": {
    "--rdp-cell-size": "40px",
    "--rdp-accent-color": "#70CBCF",
    "--rdp-background-color": "white",
    "--rdp-accent-color-dark": "#70CBCF",
    "--rdp-background-color-dark": "#2B8E8E",
    "--rdp-outline": "2px solid var(--rdp-accent-color)",
    "--rdp-outline-selected": "2px solid #70CBCF",
  },
  ...
  ".rdp-day_selected:not([disabled]), .rdp-button:focus:not([disabled])": {
    fontWeight: "semibold",
    borderColor: "main.500",
    color: "white",
    background: "main.500",
  },
  ".rdp-day_selected:hover:not([disabled]), .rdp-button:hover:not([disabled]), .rdp-dropdown:focus":
    {
      borderColor: "main.500",
      color: "main.500",
      background: "white",
