...
const whiteAlpha50 = "whiteAlpha.50";
...
const variantOutline: PartsStyleFunction<typeof parts> = (props) => {
  ...
  return {
    field: {
      ...
      bg: "inherit",
      boxShadow: noneImportant,
      _placeholder: {
        color: "veryLightPink",
      },
      _hover: {
        borderColor: mode("main.500", "whiteAlpha.400")(props),
      },
      _readOnly: {
        userSelect: "all",
      },
    ...
    addon: {
      border: "1px solid",
      borderColor: mode("inherit", whiteAlpha50)(props),
...
const variantFilled: PartsStyleFunction<typeof parts> = (props) => {
  ...
  return {
    field: {
      ...
      bg: mode("gray.100", whiteAlpha50)(props),
      _hover: {
