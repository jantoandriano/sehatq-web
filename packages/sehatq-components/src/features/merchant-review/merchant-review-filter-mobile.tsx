...
export type MerchantReviewFilterOptionsMobileProps = {
  id: string;
  label: string;
};

export type MerchantReviewFilterMobileProps = {
  filterActive: string;
  filterOptions?: MerchantReviewFilterOptionsMobileProps[];
  onChangeFilter?: (value: string) => void;
};

export function MerchantReviewFilterMobile(
  props: MerchantReviewFilterMobileProps
) {
