...
export interface MyTelemedicineBannerMobileProps {
  isMobile: boolean;
  id?: number;
  statusLabel: string;
  doctorName: string;
...
export function MyTelemedicineBannerMobile(
  props: MyTelemedicineBannerMobileProps
) {
  const {
    doctorName,
    doctorImgSrc,
        ...
        <Navigate name={myTelemedicineNavigation.name}>
          <LinkOverlay>
            <Flex align="center">
              ...
              <ChevronRightIcon boxSize={5} color="main.500" />
            </Flex>
          </LinkOverlay>
        </Navigate>
      </LinkBox>
