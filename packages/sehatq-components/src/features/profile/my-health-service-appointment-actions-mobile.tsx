...
export type MyHealthServiceAppointmentActionsMobileProps = {
  bookingId: string;
...
export function MyHealthServiceAppointmentActionsMobile(
  props: MyHealthServiceAppointmentActionsMobileProps
) {
  const {
    bookingId,
    statusCode,
