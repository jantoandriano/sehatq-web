...
export type GoToPrescriptionDetailDesktopProps = {
  isLoading: boolean;
  onClickPrescriptionDetail: () => void;
};

export function GoToPrescriptionDetailDesktop(
  props: GoToPrescriptionDetailDesktopProps
) {
  ...
  return (
    <>
      <Button
        isFullWidth
        rightIcon={<ChevronRightIcon color="charcoalGrey" boxSize={6} />}
        variant="fit"
        color="charcoalGrey"
