...
export type PrescriptionBubbleDesktopProps = {
  prescriptions: PrescriptionItemProps[];
};

export function PrescriptionBubbleDesktop(
  props: PrescriptionBubbleDesktopProps
) {
      ...
      <HStack spacing={2.5} boxShadow="base" borderRadius="lg" p={3}>
        ...
        <VStack spacing={0.5} align="flex-start" width="full">
          ...
          <Center alignItems="baseline">
            <Text fontSize="xs" color="brownGrey.500" pr={1.5}>
              Mulai dari
            </Text>
            {priceFrom && (
              <Text fontSize="sm" color="sea.500" fontWeight="bold">
