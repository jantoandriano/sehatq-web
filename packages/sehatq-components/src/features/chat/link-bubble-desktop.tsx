...
export type LinkBubbleDesktopProps = {
  metaData?: MetaDataProps;
  type: "sender" | "receiver";
};

export function LinkBubbleDesktop(props: LinkBubbleDesktopProps) {
        ...
        <>
          ...
          >
            ...
            <Box>
              ...
              <Text fontSize="sm" fontWeight="semibold" mt={1} color="sea.500">
