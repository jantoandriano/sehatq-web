...
export interface SimpleHealthCareFacilityCardMobileProps {
  hcfName: string;
  imageUrl: string;
  slug: string;
  partner: number | null;
...
export function SimpleHealthCareFacilityCardMobile(
  props: SimpleHealthCareFacilityCardMobileProps
) {
...
export function SimpleHealthCareFacilityCardSkeletonMobile() {
  const Image = useImage();
  return (
    <VStack
      spacing={1.5}
