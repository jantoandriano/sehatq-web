...
export type HealthCareFacilityFeaturesGeneralProps = {
  generalFacility: {
    id: number;
    name: string;
    imageUrl: string;
...
export type HealthCareFacilityFeaturesDesktopProps =
  ...
  return (
    <SimpleGrid columns={4} spacing={2}>
      {props.items.map((item) => (
        <HStack width="180px" spacing={1} key={item.id}>
          {item.imageUrl ? (
            <Image
              layout="fixed"
              width={16}
...
export function HealthCareFacilityFeaturesDesktop(
  props: HealthCareFacilityFeaturesDesktopProps
) {
  return (
    <Flex
      direction="column"
...
export function HealthCareFacilityFeaturesDesktopSkeleton() {
  return (
    <Flex
      direction="column"
      background="white"
