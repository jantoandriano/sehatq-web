...
export type ArticleRatingInputMobileProps = {
  average: number;
  totalReview: number;
...
export function ArticleRatingInputMobile(props: ArticleRatingInputMobileProps) {
      ...
      {submited ? (
        <Box p={8}>
          ...
          >
            ...
            <Text color="brownGrey.500">({totalReview})</Text>
          </Center>
          <Center>
            <StarRating
              iconWidth={30}
...
export function ArticleRatingInputMobileSkeleton() {
  return (
    <Flex
      borderRadius="xl"
      boxShadow="base"
