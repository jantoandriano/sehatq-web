...
export type SimpleArticleCardMobileProps = {
  slug: string;
...
export function SimpleArticleCardMobile(props: SimpleArticleCardMobileProps) {
...
export function SimpleArticleCardMobileSkeleton() {
  const Image = useImage();
  return (
