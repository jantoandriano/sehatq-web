...
export type HealthCareProfessionalSpecialityDesktopProps = {
  specialityLink: HCPSpecialityLink;
};

export function HealthCareProfessionalSpecialityLinksDesktop(
  props: HealthCareProfessionalSpecialityDesktopProps
) {
