...
export type HealthCareProfessionalDistrictMobileProps = {
...
export function HealthCareProfessionalDistrictLinksMobile(
  props: HealthCareProfessionalDistrictMobileProps
) {
