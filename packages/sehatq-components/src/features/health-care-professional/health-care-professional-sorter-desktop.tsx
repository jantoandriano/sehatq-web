...
export type HealthCareProfessionalSorterDesktopProps = {
...
export function HealthCareProfessionalSorterDesktop(
  props: HealthCareProfessionalSorterDesktopProps
) {
...
export function HealthCareProfessionalSorterDesktopSkeleton() {
  return (
