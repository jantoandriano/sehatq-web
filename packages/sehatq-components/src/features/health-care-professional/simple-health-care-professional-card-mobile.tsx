...
export type SimpleHealthCareProfessionalCardMobileProps = {
  doctorName: string;
  doctorSlug: string;
  speciality: string;
  hcfName: string;
...
export function SimpleHealthCareProfessionalCardMobile(
  props: SimpleHealthCareProfessionalCardMobileProps
) {
...
export function SimpleHealthCareProfessionalCardMobileSkeleton() {
  return (
    <Flex
      flexDirection="column"
      align="center"
