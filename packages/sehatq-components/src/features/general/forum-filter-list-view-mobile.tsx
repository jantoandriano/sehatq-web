...
export type FilterListViewMobileProps = GeneralProps &
  ...
  return (
    <InputGroup background="white" borderRadius="xl" boxShadow="lg">
      ...
      <Input
        px={10}
        value={searchValue}
        placeholder="Cari Kategori Forum"
        fontSize="xs"
        autoComplete="off"
...
export function ForumFilterListViewMobile(props: FilterListViewMobileProps) {
