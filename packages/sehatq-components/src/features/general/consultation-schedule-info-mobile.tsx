...
export type ConsultationScheduleInfoMobileProps = {
  doctorId: string;
  scheduleDay: string;
  scheduleTime: string;
};

export function ConsultationScheduleInfoMobile(
  props: ConsultationScheduleInfoMobileProps
) {
...
export function ConsultationScheduleInfoMobileSkeleton() {
  return (
