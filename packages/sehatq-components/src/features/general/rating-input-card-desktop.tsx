...
export type RatingInputCardDesktopProps = {
  average: number;
  totalReview: number;
...
export function RatingInputCardDesktop(props: RatingInputCardDesktopProps) {
...
export function RatingInputCardDesktopSkeleton() {
  return (
    <Flex
      borderRadius="xl"
      boxShadow="base"
