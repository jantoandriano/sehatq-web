...
export type RatingInputCardMobileProps = {
  average: number;
  totalReview: number;
...
export function RatingInputCardMobile(props: RatingInputCardMobileProps) {
...
export function RatingInputCardMobileSkeleton() {
  return (
    <Flex
      borderRadius="xl"
      boxShadow="base"
