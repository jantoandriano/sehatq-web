...
export interface SimpleForumCardDesktopProps {
  title: string;
  slug: string;
  answeredBy: string;
  category?: {
...
export function SimpleForumCardDesktop({
  title,
  slug,
  answeredBy,
  category,
  ...
  return (
    <LinkBox padding={3} borderRadius="lg" boxShadow="base" height="100%">
      {category ? (
...
export function SimpleForumCardDesktopSkeleton() {
  return (
