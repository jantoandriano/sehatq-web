...
export type TelemedicineLandingHCPCardMobileProps = {
  doctorId: number;
  doctorName: string;
  doctorSlug: string;
  speciality: string;
...
export function TelemedicineLandingHCPCardMobile(
  props: TelemedicineLandingHCPCardMobileProps
) {
  const Image = useImage();
  return (
    <LinkBox width="full" height="160px">
      <Flex
        direction="row"
...
export function TelemedicineLandingHCPCardMobileSkeleton() {
  return (
    <Flex
      direction="row"
      justify="space-between"
    ...
    >
      ...
      <VStack justify="space-between" height="full" align="end">
