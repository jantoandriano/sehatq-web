...
import { TelemedicineQuickFilterMobile } from "./telemedicine-quick-filter-mobile";

export type TelemedicineQuickFilterProps = {
  page: string;
  perPage: string;
  sortBy?: string;
  userLat?: string;
...
export type QuickFilterKeys = "specialitySlug" | "price" | "sort";

export function TelemedicineQuickFilter(props: TelemedicineQuickFilterProps) {
  const {
    page = "1",
    perPage = "12",
    sortBy = "",
  ...
  return <TelemedicineQuickFilterMobile {...otherProps} />;
}
